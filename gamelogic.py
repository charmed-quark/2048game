...
class GameLogic:
    ...
    def gameloop(self):
        ...
        while True:
            ...
            spawn_on_next_turn = True
            if self.next_move == "left" and self.game_grid != GameLogic.moves.move_left(self.game_grid):
                self.game_grid = GameLogic.moves.move_left(self.game_grid)
            elif self.next_move == "right" and self.game_grid != GameLogic.moves.move_right(self.game_grid):
                self.game_grid = GameLogic.moves.move_right(self.game_grid)
            elif self.next_move == "up" and self.game_grid != GameLogic.moves.move_up(self.game_grid):
                self.game_grid = GameLogic.moves.move_up(self.game_grid)
            elif self.next_move == "down" and self.game_grid != GameLogic.moves.move_down(self.game_grid):
                self.game_grid = GameLogic.moves.move_down(self.game_grid)
            elif self.next_move == "quit":  #quit
                sys.exit()
